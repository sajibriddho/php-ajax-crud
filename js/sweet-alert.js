! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).Sweetalert2 = t() }(this, function() {
    ...
    const Se = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        $e = (e, t) => { Xe(e, t), Te(e, t), Ze(e, t), Ne(e, t), Ye(e, t), Je(e, t), Ve(e, t), Ie(e, t), xe(e, t), qe(e, t), "function" == typeof t.didRender && t.didRender(g()) },
    ...
    function Ot(e, t, n, o) { Z() ? Ht(e, o) : (he(n).then(() => Ht(e, o)), f.keydownTarget.removeEventListener("keydown", f.keydownHandler, { capture: f.keydownListenerCapture }), f.keydownHandlerAdded = !1), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), Y() && (gt(), bt(), et()), oe([document.documentElement, document.body], [p.shown, p["height-auto"], p["no-backdrop"], p["toast-shown"]]) }
    ...
    const Mt = e => { e.isAwaitingPromise() && (b.awaitingPromise.delete(e), b.innerParams.get(e) || e._destroy()) },
        Dt = (e, t, n) => {
            var o, i, a, r = m(),
                s = Be && de(t);
            "function" == typeof n.willClose && n.willClose(t), s ? (s = e, o = t, t = r, i = n.returnFocus, a = n.didClose, f.swalCloseEventFinishedCallback = Ot.bind(null, s, t, i, a), o.addEventListener(Be, function(e) { e.target === o && (f.swalCloseEventFinishedCallback(), delete f.swalCloseEventFinishedCallback) })) : Ot(e, r, n.returnFocus, n.didClose)
        },
    ...
    const Vt = e => { e.isAwaitingPromise() ? (Nt(b, e), b.awaitingPromise.set(e, !0)) : (Nt(Lt, e), Nt(b, e)) },
        Nt = (e, t) => { for (const n in e) e[n].delete(t) };
    e = Object.freeze({
        hideLoading: St,
        disableLoading: St,
        ...
        closeModal: jt,
        closeToast: jt,
        enableButtons: function() { It(this, ["confirmButton", "denyButton", "cancelButton"], !1) },
        disableButtons: function() { It(this, ["confirmButton", "denyButton", "cancelButton"], !0) },
        enableInput: function() { return qt(this.getInput(), !1) },
        disableInput: function() { return qt(this.getInput(), !0) },
    ...
    const Rt = (e, t) => {
            ...
            if (n.inputValidator) {
                ...
                c.then(e => { i.enableButtons(), i.enableInput(), e ? i.showValidationMessage(e) : ("deny" === r ? Ft : zt)(i, a) })
        ...
        Ft = (t, n) => {
            ...
            if (e.showLoaderOnDeny && At(N()), e.preDeny) {
                ...
                o.then(e => {!1 === e ? (t.hideLoading(), Mt(t)) : t.closePopup({ isDenied: !0, value: void 0 === e ? n : e }) }).catch(e => Wt(t || void 0, e))
            } else t.closePopup({ isDenied: !0, value: n })
        },
        Ut = (e, t) => { e.closePopup({ isConfirmed: !0, value: t }) },
        Wt = (e, t) => { e.rejectPromise(t) },
        zt = (t, n) => {
            const e = b.innerParams.get(t || void 0);
            if (e.showLoaderOnConfirm && At(), e.preConfirm) {
                ...
                o.then(e => { ce(q()) || !1 === e ? (t.hideLoading(), Mt(t)) : Ut(t, void 0 === e ? n : e) }).catch(e => Wt(t || void 0, e))
            } else Ut(t, n)
        },
        _t = (n, e, o) => {
            e.popup.onclick = () => {
    ...
    let Kt = !1;
    const Yt = t => { t.popup.onmousedown = () => { t.container.onmouseup = function(e) { t.container.onmouseup = void 0, e.target === t.container && (Kt = !0) } } },
        Zt = t => { t.container.onmousedown = () => { t.popup.onmouseup = function(e) { t.popup.onmouseup = void 0, e.target !== t.popup && !t.popup.contains(e.target) || (Kt = !0) } } },
        Jt = (n, o, i) => {
            ...
            if (i && (!n.isComposing && 229 !== n.keyCode))
                ...
                if ([...Gt, ...Qt].includes(n.key)) {
                    ...
                    if ([s, c, l].includes(document.activeElement)) {
                        ...
                        for (let e = 0; e < U().children.length; e++) { if (!(t = t[u])) return; if (ce(t) && t instanceof HTMLButtonElement) break }
    ...
    const on = () => {
        ...
        an = () => { var e; if (f.timeout) return e = f.timeout.start(), J(e), e };
    let rn = !1;
    const sn = {};
    const cn = t => {
        for (let e = t.target; e && e !== document; e = e.parentNode)
            for (const o in sn) { var n = e.getAttribute(o); if (n) return void sn[o].fire({ template: n }) }
    };
    var ln = Object.freeze({
        isValidParameter: B,
        isUpdatableParameter: x,
        isDeprecatedParameter: E,
        argsToParams: n => { const o = {}; return "object" != typeof n[0] || nn(n[0]) ? ["title", "html", "icon"].forEach((e, t) => { t = n[t]; "string" == typeof t || nn(t) ? o[e] = t : void 0 !== t && v("Unexpected type of ".concat(e, '! Expected "string" or "Element", got ').concat(typeof t)) }) : Object.assign(o, n[0]), o },
        isVisible: () => ce(g()),
        clickConfirm: Xt,
        clickDeny: () => N() && N().click(),
        ...
        stopTimer: on,
        resumeTimer: an,
        toggleTimer: () => { var e = f.timeout; return e && (e.running ? on : an)() },
    ...
    const pn = (l, u, d) => new Promise((e, t) => {
        ...
        gn = e => { var t = { popup: g(), container: m(), actions: U(), confirmButton: V(), denyButton: N(), cancelButton: F(), loader: R(), closeButton: _(), validationMessage: q(), progressSteps: I() }; return b.domCache.set(e, t), t },
        hn = (e, t, n) => {
            var o = z();
        ...
        fn = (e, t) => { if (!t.toast) return w(t.allowEnterKey) ? void(bn(e, t) || $t(t, -1, 1)) : yn() },
        ...
        vn = (Object.assign(dn.prototype, e), Object.assign(dn, ln), Object.keys(e).forEach(e => { dn[e] = function() { if (un) return un[e](...arguments) } }), dn.DismissReason = Ge, dn.version = "11.4.4", dn);
